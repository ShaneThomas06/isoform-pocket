...
The seven AF3-derived residues form a compact surface: 18
...
AF3 and crystal pair distances agree with R^2 = 0.998
and a mean absolute error of 0.13 A. This
supports the geometry of the p120 surface, not RAC binding to it.

## Relation to the experimentally implicated motif

The closest candidate-surface distance to CTNND1 622-628 is 58.1 A.
Mean AF3 residue confidence is 87.4 for the
candidate surface and 37.1 for the motif. The
